...
<style>
    ...
    .cmr-table tbody tr:hover td {
        background: #f8f9ff;
    }
    .cmr-table tbody tr:last-child td {
        border-bottom: none;
    }
    .cmr-table .year {
        font-weight: 700;
    ...
    .cmr-table .y2023 { color: #10b981; }
    .cmr-table .y2024 { color: #3b82f6; }
    .cmr-table .y2025 { color: #8b5cf6; }
    .cmr-table .y2026 { color: #ec4899; }
    .cmr-table .subjects {
        font-weight: 700;
        text-align: center;
    }
    .cmr-table .center { text-align: center; }
</style>
...
Doi: https://doi.org/10.1109/TMI.2018.2863670
